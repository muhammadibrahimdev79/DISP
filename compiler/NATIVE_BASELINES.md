...
| --- | --- | ---: |
| Compiler startup plus `check hello.disp` | debug bootstrap compiler, mean of 5 | 20.022 ms |
| `hello.disp` build | debug native output, mean of 5 | 306.059 ms |
...
`examples/native_arithmetic_benchmark.disp` and
`examples/native_recursive_benchmark.disp`.
