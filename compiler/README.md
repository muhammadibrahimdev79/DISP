...
- nominal owned `Url` values and bounded validated `Json` documents, including native JSON HTTP request/response integration without a dynamic parser dependency
